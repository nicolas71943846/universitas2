                    ...
                    <div class="column is-half">
                            ...
                            <table border="1" style="align-items: center">
                                <tr>
                                    <%
                                        ...
                                        //Se hace un ciclo doble para imprimir cada valor del arreglo y su posición
                                        for (int i = 0; i < arreglo.length; i++) {
                                    %>

                                    <td style="text-align: center; width: 15px"><%= arreglo[i] %>
                                    </td>
                                    <%
                                        }
                                    %>
                                ...
                                <tr>
                                    <%
                                        for (int i = 0; i < arreglo.length; i++) {
                                    %>
                                    <td style="text-align: center; width: 15px"><%= i %>
                                    </td>
                                    <%
                                        }
                                    %>
                        ...
                        <p>
                            ...
                            <script>
                                ...
                                //Función para organizar el arreglo y validar si es palindromo
                                ...
                                //Se declara una variable para validar si la frase es un palindromo
                                var resultado = esPalindromo(frase);

                                //Se muestra el resultado dentro de un div para verlo en pantalla
